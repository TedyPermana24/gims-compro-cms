...
import { X, Trash2, ShoppingCart, Phone } from "lucide-react";
      ...
      >
        <div className="w-[300px] bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            <a
              href="https://wa.me/6202230502080?text=Halo%20GiMS!%20Saya%20ingin%20bertanya%20mengenai%20layanan%20Anda."
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 rounded-xl border border-slate-100 hover:bg-[#25d366]/5 hover:border-[#25d366]/20 transition-all group"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-xs text-slate-500">022 3050 2080</span>
                </div>
              </div>
              <span className="text-xs text-[#25d366] font-semibold group-hover:underline flex-shrink-0">Chat</span>
            </a>
          </div>
